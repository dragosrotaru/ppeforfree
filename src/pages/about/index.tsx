...
export const About = () => (
  <div className="about-container">
    <div>
      ...
      <hr />
      <p>
        PPEForFree is a sense-making movement by the people and for the people. We combine
        Open Source Intelligence (OSINT) and Data Science capabilities with the ethos and
        community of Wikipedia to help light a path for the millions of restless minds
        searching for the means to fight the PPE shortage.
      </p>
      <p>
        Today we live in an age defined by an unprecedented amount of digital information.
        Sadly, our information ecology, the internet, is polluted with misinformation, low
        quality data, fake news, spam and a whole suite of other related issues.
      </p>
      <p>
      ...
      <p>
        ...
        community through what we call the Grassroots PPE Supply Chain. We want to turn it
        up all the way to 11. We are going to amplify the signal, reduce the noise by
        attempting to fix the information ecology of the PPE supply chain using a fresh
        new approach. How are we going to do this?
      </p>
      <ul>
        <li>
        ...
        <li>
          crowd-source discovery of new groups by allowing users to submit links on the
          website.
        </li>
        <li>
        ...
        <li>
          provide an open API and a kickass open-source community so potential competitors
          work with us instead.
        </li>
        <li>
          convince as many leaders as possible to include a link to this website somewhere
          where it is visible to every single person in their organisation.
        </li>
        <li>
        ...
        <li>
          create a comprehensive gold standard repository of PPE designs, methodologies,
          processes, tools, etc.
        </li>
        <li>
          provide a legal framework with free waivers for every juristiction to allow
          those donating homemade PPE to do so knowing they are staying within the law.
        </li>
      </ul>
